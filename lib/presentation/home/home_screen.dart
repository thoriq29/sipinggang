...
class HomeScreen extends StatelessWidget {
  ...
  static CollectionReference _collectionReference = FirebaseFirestore.instance.collection('diagnosticResults');
        ...
        body: Consumer<AuthProvider>(
          builder: (context, authProvider, _) {
            return StreamBuilder<QuerySnapshot>(
              stream: _collectionReference.where("userDocUid", isEqualTo: authProvider.auth.currentUser?.uid).snapshots(),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      onTap: () {
                        ...
                        context,
                        MaterialPageRoute(
                          builder: (context) => HasilDiagnosaScreen(diagnosaData: {

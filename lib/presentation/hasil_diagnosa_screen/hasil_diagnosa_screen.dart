                              ...
                              Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                                                    ...
                                                                    child: RichText(
                                                                        text: TextSpan(
                                                                            children: [
                                                                              TextSpan(
                                                                                  text:
                                                                                    diagnosaData != null ?  "Anda terdiagnosa ${diagnosaData!['type'].toString()} mengalami :\n" :
                                                                              ...
                                                                              TextSpan(
                                                                                  text:
                                                                                    diagnosaData != null ? diagnosaData!["diagnosis"] + "\n\n\n" : provider.result?["title"]+ "\n\n\n",
                                                                                  style: TextStyle(
                                                                                      color: ColorConstant.black900,
                                                                                      fontSize: getFontSize(16),
                                                                                      fontFamily: 'Cairo',
                                                                              ...
                                                                              TextSpan(
                                                                                  text:
                                                                                   diagnosaData != null ? diagnosaData!["solutions"].join("\n") :  provider.result?["solusi"].join("\n"),
                                                                                  style: TextStyle(
                                                                                      color: ColorConstant.black900,
                                                                                      fontSize: getFontSize(16),
                                                                                      fontFamily: 'Cairo',
                                        ...
                                        diagnosaData == null ? CustomButton(
                                          onTap: () async {
                                            AppWidget.loadingPageIndicator(context: context);
                                            await UsersDiagnosisDatabase().addDiagnosticResult({
                                              "userDocUid": authProvider.auth.currentUser?.uid,
                                              "diagnosis": provider.result?["title"],
                                              "diagnosisDate": DateTime.now(),
                                              "type": provider.typeHasil,
                                              "solutions": provider.result?["solusi"],
                                              "code": provider.result?["diagnosaCode"].toString()
                                            }).then((value) => {
                                              Navigator.of(context).pop(),
                                              Navigator.of(context).pop(),
                                              Navigator.of(context).pop(),
                                              Navigator.pushReplacementNamed(context, AppRoutes.homeScreen),
                                              AppWidget.showSnackBar(context: context, content: Text("Data berhasil disimpan"), duration: Duration(seconds: 2))
                                            });
